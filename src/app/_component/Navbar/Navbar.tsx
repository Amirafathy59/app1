...
console.log('cart Data..' , cartData);
 ...
 console.log(status)
  return (
    <NavigationMenu className='bg-gray-100 sticky top-0 z-50 max-w-full p-3 '>
...
<Button onClick={handleLogout} className='bg-green-600 py-2 px-3 text-white rounded-md'>
  <span>logOut</span>
</Button></> :<Button className='bg-green-600 py-2 px-3 text-white rounded-md'>
